...
public class ListTipoTransacao extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_emp_list_tipo_trans);
        ...
        adapter = new SimpleCursorAdapter(this, R.layout.act_view_tipo_transacao, cursor, from, to, 0);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long viewId) {
                ...
                String tipoTransacao = titleTextView.getText().toString();
                //String desc = descTextView.getText().toString();

                Intent modify_intent = new Intent(getApplicationContext(), EditTipoTransacao.class);
                modify_intent.putExtra("Titulo", tipoTransacao);
